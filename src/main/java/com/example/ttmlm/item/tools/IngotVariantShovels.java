        ...
        switch (this.variant){
            case ENDER_ALLOY:
                ...
                ITextComponent preContainerInfo = new StringTextComponent("Linked Container : ")
                        .applyTextStyles(TextFormatting.LIGHT_PURPLE, TextFormatting.ITALIC);
                ITextComponent BaseInfo = new StringTextComponent("Ender Touch : Teleports what you dig!")
                        .applyTextStyles(TextFormatting.LIGHT_PURPLE, TextFormatting.ITALIC);
                ...
                break;
            case BLAZING_ALLOY:
                tooltip.add(new StringTextComponent("\u00A76\u00A7oBlazing Touch :\u00A7d Cook what you dig!"));
                break;
            case FREEZING_ALLOY:
            ...
            case WEAK_ENDER_ALLOY:
                tooltip.add(new StringTextComponent("Ender Touch : Teleports what you dig!")
                        .applyTextStyles(TextFormatting.LIGHT_PURPLE, TextFormatting.ITALIC));
        }
    }
