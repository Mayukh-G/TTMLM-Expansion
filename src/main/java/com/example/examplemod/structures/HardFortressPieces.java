...
public class HardFortressPieces {
    ...
    private static final ResourceLocation SMALL_ENTRANCE = ExampleMod.getID("fortress/fortress_small_entrance");
    private static final ResourceLocation ENTRANCE = ExampleMod.getID("fortress/fortress_big_entrance");
    private static final ResourceLocation TRANSITION = ExampleMod.getID("fortress/fortress_transition");
    private static final ResourceLocation SMALL_TREASURE = ExampleMod.getID("fortress/fortress_small_treasure_deadend");
    private static final ResourceLocation SMALL_HALLWAY = ExampleMod.getID("fortress/fortress_small_hallway_01");
    private static final ResourceLocation OUTSIDE_TURN = ExampleMod.getID("fortress/fortress_outside_turn");
    private static final ResourceLocation INSIDE_TURN = ExampleMod.getID("fortress/fortress_inside_turn");
    private static final ResourceLocation HALLWAY_03 = ExampleMod.getID("fortress/fortress_hallway_03");
    private static final ResourceLocation HALLWAY_02 = ExampleMod.getID("fortress/fortress_hallway_02");
    private static final ResourceLocation HALLWAY_01 = ExampleMod.getID("fortress/fortress_hallway_01");
    private static final ResourceLocation DEADEND_SPAWNER = ExampleMod.getID("fortress/fortress_deadend_spawner");
    private static final ResourceLocation DEADEND_CHEST = ExampleMod.getID("fortress/fortress_deadend_chest");
    private static final ResourceLocation BOSS_ROOM = ExampleMod.getID("fortress/fortress_boss_room");
