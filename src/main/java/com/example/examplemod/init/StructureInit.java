...
import com.example.examplemod.structures.HardFortress;
import com.example.examplemod.structures.HardFortressPieces;
import com.example.examplemod.structures.SnowDungeon;
import com.example.examplemod.structures.SnowDungeonPieces;
...
public class StructureInit {
    ...
    public static void registerFeatures(RegistryEvent.Register<Feature<?>> event){
        ...
        ExampleMod.register(registry, HARD_FORTRESS, "hard_fortress");
        register(HFP, "HFP");
        ExampleMod.register(registry, Snow_Dungeon, "snow_dungeon");
        register(SDP, "SDP");
    }
