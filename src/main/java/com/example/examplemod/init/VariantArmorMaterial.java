...
public enum VariantArmorMaterial implements IArmorMaterial {
    ...
    WEAK_ENDER("weak_ender", 40, new int[]{4,7,8,4},12, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 2.0F, () -> {
        return Ingredient.fromItems(IngotVariants.WEAK_ENDER_ALLOY.getIngotItem());
    }),
    VARIANT_BLAZING("variant_blazing", 44, new int[]{5,7,9,5},13, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 3.0F, () -> {
        return Ingredient.fromItems(IngotVariants.BLAZING_ALLOY.getIngotItem());
    }),
    VARIANT_FREEZING("variant_freezing", 44, new int[]{5,7,9,5},13, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 3.0F, () -> {
        return Ingredient.fromItems(IngotVariants.FREEZING_ALLOY.getIngotItem());
    }),
    ENDER("ender", 48, new int[]{5,8,10,5},13, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 3.5F, () -> {
