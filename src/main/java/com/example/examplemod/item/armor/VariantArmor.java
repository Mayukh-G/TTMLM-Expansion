...
public class VariantArmor extends ArmorItem {
    ...
    private static final UUID[] HEALTH_BONUS_PLUS_25 = new UUID[]{UUID.fromString("bc5640bf-c50a-4943-aba6-2cc496bc4dc9"), UUID.fromString("290b0fe4-da68-4e7f-8e8f-2da5149c7b73")};
    private static final UUID[] HEALTH_BONUS_PLUS_20 = new UUID[]{UUID.fromString("c42da457-9c55-4925-ab23-80b0569239f7"), UUID.fromString("645f9850-39fb-4d48-b52f-ea992d186004")};
    private static final UUID[] HEALTH_BONUS_PLUS_10 = new UUID[]{UUID.fromString("1fee06d1-744e-40e2-b77d-b16c7e783536"),UUID.fromString("034e442d-b194-49bb-a243-ccfe1547be7c")};
    ...
    public Multimap<String, AttributeModifier> getAttributeModifiers(@Nonnull EquipmentSlotType equipmentSlot) { //UUIDS were the problem, knockback still wonky af
        ...
        if (equipmentSlot == this.slot) {
            ...
            if ((this.material == VariantArmorMaterial.WEAK_VARIANT_FREEZING || this.material == VariantArmorMaterial.WEAK_ENDER) && (this.slot == EquipmentSlotType.CHEST || this.slot == EquipmentSlotType.LEGS)) {
                ...
                multimap.put(SharedMonsterAttributes.MAX_HEALTH.getName(), new AttributeModifier(HEALTH_BONUS_PLUS_20[index],"Heath Bonus", 0.2D, AttributeModifier.Operation.MULTIPLY_BASE));
            }
                ...
                if(this.slot == EquipmentSlotType.CHEST || this.slot == EquipmentSlotType.LEGS){
                    ...
                    multimap.put(SharedMonsterAttributes.MAX_HEALTH.getName(), new AttributeModifier(HEALTH_BONUS_PLUS_10[index],"Heath Bonus", 0.1D, AttributeModifier.Operation.MULTIPLY_BASE));
                }
            } else {
                if(this.slot == EquipmentSlotType.CHEST || this.slot == EquipmentSlotType.LEGS){
                    if(this.slot == EquipmentSlotType.CHEST) { index = 0; }
