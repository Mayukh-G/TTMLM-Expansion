...
public class BlazingingTouchModifier extends LootModifier {
    /**
     * Constructs a LootModifier.
     *
     * @param conditionsIn the ILootConditions that need to be matched before the loot is modified.
     */
    protected BlazingingTouchModifier(ILootCondition[] conditionsIn) {
        super(conditionsIn);
    }
    ...
    public static class Serializer extends GlobalLootModifierSerializer<BlazingingTouchModifier> {
        @Override
        public BlazingingTouchModifier read(ResourceLocation name, JsonObject json, ILootCondition[] conditionsIn) {
            return new BlazingingTouchModifier(conditionsIn);
        }
    }
}
